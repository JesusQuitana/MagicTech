...
//############CONSULTAR LAS CATEGORIAS DISPONIBLES#############
...
//############VALIDACION DE LOS ATRIBUTOS PRODUCTO#############
    $errores = $producto->validar("create");
}
?>
...
<!--################FORMULARIO#############################-->
    <form method="post" enctype="multipart/form-data">
        <fieldset class="contenedor_contacto">
            ...
            <input type="text" id="nombre" name="nombre" class="inputs_contacto" value="<?php echo $producto->nombre ?? ""; ?>">
